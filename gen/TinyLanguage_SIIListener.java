...
public interface TinyLanguage_SIIListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link TinyLanguage_SIIParser#instelse}.
	 * @param ctx the parse tree
	 */
	void enterInstelse(TinyLanguage_SIIParser.InstelseContext ctx);
	/**
	 * Exit a parse tree produced by {@link TinyLanguage_SIIParser#instelse}.
	 * @param ctx the parse tree
	 */
	void exitInstelse(TinyLanguage_SIIParser.InstelseContext ctx);
	/**
